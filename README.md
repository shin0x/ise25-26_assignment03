...
```
#### Create Bakery Kohlmann:
```
curl --header "Content-Type: application/json" --request POST --data '{"name":"Bäckerei Kohlmann GmbH","description":"Bad reviews","type":"BAKERY","campus":"INF","street":"Im Neuenheimer Feld","houseNumber":"370","postalCode":69120,"city":"Heidelberg"}' http://localhost:8080/api/pos
```
### Get Bakery Kohlmann:
```
